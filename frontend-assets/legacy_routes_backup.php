...
/*
|--------------------------------------------------------------------------
| Legacy Monolithic Web Routes Backup (Reference for API Module Migration)
|--------------------------------------------------------------------------
|
| Use this file to reference original route names, controller actions,
| middleware protections, and route parameters when building REST API endpoints.
|
*/
